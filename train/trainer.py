            ...
            "animals": [
                {
                    ...
                    "prey_score": int(animal.prey_score),
                    "movement_speed": int(animal.movement_speed),
                    "carnivore": bool(animal.carnivore),
                    "gender": str(animal.gender),
                    "litter_size_min": int(animal.litter_size_min),
                    "litter_size_max": int(animal.litter_size_max),
